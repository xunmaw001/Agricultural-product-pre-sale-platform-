...
public class ZuowuzhuangtaiEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZuowuzhuangtaiEntity() {

	}

	public ZuowuzhuangtaiEntity(T t) {
		try {
    ...
    public String toString() {
        return "Zuowuzhuangtai{" +
            "id=" + id +
            ", dipiOrderId=" + dipiOrderId +
            ", zuowuzhuangtaiJieduanTypes=" + zuowuzhuangtaiJieduanTypes +
            ", zuowuzhuangtaiTypes=" + zuowuzhuangtaiTypes +
            ", zuowuzhuangtaiPhoto=" + zuowuzhuangtaiPhoto +
