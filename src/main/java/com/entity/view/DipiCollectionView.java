 ...
 */
@TableName("dipi_collection")
public class DipiCollectionView extends DipiCollectionEntity implements Serializable {
	...
	public DipiCollectionView() {

	}

	public DipiCollectionView(DipiCollectionEntity dipiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, dipiCollectionEntity);
