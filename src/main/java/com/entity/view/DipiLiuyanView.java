 ...
 */
@TableName("dipi_liuyan")
public class DipiLiuyanView extends DipiLiuyanEntity implements Serializable {
	...
	public DipiLiuyanView() {

	}

	public DipiLiuyanView(DipiLiuyanEntity dipiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, dipiLiuyanEntity);
