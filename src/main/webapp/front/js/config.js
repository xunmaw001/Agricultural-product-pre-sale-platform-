...
var centerMenu = [
    ...
    ,{
        name: '地皮收藏',
        url: '../dipiCollection/list.jsp'
    }
    ,{
        name: '地皮订单',
        url: '../dipiOrder/list.jsp'
    }
...
var adminurl =  "http://localhost:8080/nongchanpinyushou/index.jsp";
