            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">客户姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="kehuName" id="kehuName"  placeholder="客户姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">客户手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="kehuPhone" id="kehuPhone"  lay-verify="phone|required"   placeholder="客户手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">客户身份证号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="kehuIdNumber" id="kehuIdNumber"  lay-verify="identity|required"   placeholder="客户身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="kehuAddress" id="kehuAddress"  placeholder="现住地址"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">出生年月:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="kehuTime" id="kehuTime"  placeholder="出生年月"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
