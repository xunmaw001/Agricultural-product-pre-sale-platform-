				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kehuName" id="kehuName" lay-verify="required" placeholder="客户姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kehuPhone" id="kehuPhone"  lay-verify="required|phone"   placeholder="客户手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kehuIdNumber" id="kehuIdNumber"  lay-verify="required|identity"   placeholder="客户身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kehuAddress" id="kehuAddress" lay-verify="required" placeholder="现住地址" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kehuTime" id="kehuTime"  <%--lay-verify="required|date"--%>   placeholder="出生年月" autocomplete="off" class="layui-input">
							</div>
						</div>
