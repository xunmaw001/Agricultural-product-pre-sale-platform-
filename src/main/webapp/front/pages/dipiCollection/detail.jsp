    ...
    <div class="data-detail">
        <div class="data-detail-breadcrumb">
					<span class="layui-breadcrumb">
						...
						<a><cite>{{detail.dipiCollectionName}}</cite></a>
					</span>
        ...
        <div class="layui-row">
            ...
            <div class="layui-col-md7" style="padding-left: 20px;">
                ...
                <div class="detail-item">
                    ...
                    <!--<button onclick="addDipiCollectionqqqqqqqq()" type="button" class="layui-btn layui-btn-warm">
                        添加到购物车
                    </button>-->
                </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function (res) {
            ...
            vue.detail = res.data;
           // 轮播图片
            vue.swiperList = vue.detail.dipiCollectionPhoto ? vue.detail.dipiCollectionPhoto.split(",") : [];
            var swiperItemHtml = '';
