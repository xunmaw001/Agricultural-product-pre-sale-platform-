            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">地皮展示</span>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../dipi/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../dipi/detail.jsp?id='+item.id)"><span>{{item.dipiName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 dipiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            dipiContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            param['dipiTypes'] = 1;
                                                    // 获取列表数据
            http.request('dipi/list', 'get', param, function(res) {
