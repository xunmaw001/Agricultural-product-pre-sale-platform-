            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">订单展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="dingdanWupin" id="dingdanWupin" placeholder="发货物品" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="xingming" id="xingming" placeholder="收货人" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="dingdanDanhaoNumber" id="dingdanDanhaoNumber" placeholder="单号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#dingdanWupin').val() != null && jquery('#dingdanWupin').val() != "" && jquery('#dingdanWupin').val() != "null" ) {
                param['dingdanWupin'] = jquery('#dingdanWupin').val();
            }
                 
            if (jquery('#xingming').val() != null && jquery('#xingming').val() != "" && jquery('#xingming').val() != "null" ) {
                param['xingming'] = jquery('#xingming').val();
            }
                         
            if (jquery('#dingdanDanhaoNumber').val() != null && jquery('#dingdanDanhaoNumber').val() != "" && jquery('#dingdanDanhaoNumber').val() != "null" ) {
                param['dingdanDanhaoNumber'] = jquery('#dingdanDanhaoNumber').val();
            }
                                    // 获取列表数据
