              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">作物名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zuowuName" id="zuowuName"  placeholder="作物名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">作物类型:</span>
                        <div class="layui-input-inline">
                            <select name="zuowuTypes" id="zuowuTypes" lay-filter="zuowuTypes" style="width: 600px;">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <select name="dipiOrderYesnoTypes" id="dipiOrderYesnoTypes" lay-filter="dipiOrderYesnoTypes" style="width: 600px;">
