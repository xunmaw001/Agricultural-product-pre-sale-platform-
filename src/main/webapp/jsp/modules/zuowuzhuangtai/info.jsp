            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">作物状态登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>地皮</label>
                                            <input id="dipiId" name="dipiId" class="form-control"
                                                   v-model="ruleForm.dipiId" readonly>
                                        </div>


                                        <div class="form-group col-md-6">
                                            <label>客户</label>
                                            <input id="kehuId" name="kehuId" class="form-control"
                                                   v-model="ruleForm.kehuId" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="dipiOrderId" name="dipiOrderId" v-model="ruleForm.dipiOrderId" readonly type="hidden">

                                <div class="form-group col-md-6">
                                    <label>作物阶段</label>
                                    <input id="zuowuzhuangtaiJieduanValue" name="zuowuzhuangtaiJieduanValue" class="form-control"
                                           v-model="ruleForm.zuowuzhuangtaiJieduanValue" readonly>
                                </div>


                                <div class="form-group col-md-6">
                                    <label>作物状态</label>
                                    <input id="zuowuzhuangtaiValue" name="zuowuzhuangtaiValue" class="form-control"
                                           v-model="ruleForm.zuowuzhuangtaiValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>作物图片</label>
                                    <img id="zuowuzhuangtaiPhotoImg" width="100" height="100">
                                </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "zuowuzhuangtai/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.zuowuzhuangtaiContent != null && ruleForm.zuowuzhuangtaiContent != 'null' && ruleForm.zuowuzhuangtaiContent != '') {
            var zuowuzhuangtaiContentUeditor = UE.getEditor('zuowuzhuangtaiContentEditor');
                zuowuzhuangtaiContentUeditor.ready(function () {
                    var mes = '' + ruleForm.zuowuzhuangtaiContent;
                    zuowuzhuangtaiContentUeditor.setContent(mes);
                    zuowuzhuangtaiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
