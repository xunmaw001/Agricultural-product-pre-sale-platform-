            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">地皮订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="dipiName" name="dipiName" class="form-control"
                                                   v-model="ruleForm.dipiName" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="dipiWeizhi" name="dipiWeizhi" class="form-control"
                                                   v-model="ruleForm.dipiWeizhi" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>地皮缩略图</label>
                                        <img id="dipiPhotoImg" width="100" height="100">
                                    </div>

                                        <div class="form-group col-md-6">
                                            <label>地皮价格</label>
                                            <input id="dipiNewMoney" name="dipiNewMoney" class="form-control"
                                                   v-model="ruleForm.dipiNewMoney" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="dipiValue" name="dipiValue" class="form-control"
                                               v-model="ruleForm.dipiValue" readonly>
                                    </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="kehuAddress" name="kehuAddress" class="form-control"
                                                   v-model="ruleForm.kehuAddress" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="kehuTime" name="kehuTime" class="form-control"
                                                   v-model="ruleForm.kehuTime" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="dipiId" name="dipiId" v-model="ruleForm.dipiId" readonly type="hidden">
                                <input id="kehuId" name="kehuId" v-model="ruleForm.kehuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="zuowuName" name="zuowuName" class="form-control"
                                               v-model="ruleForm.zuowuName" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="zuowuValue" name="zuowuValue" class="form-control"
                                           v-model="ruleForm.zuowuValue" readonly>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="dipiOrderYesnoValue" name="dipiOrderYesnoValue" class="form-control"
                                           v-model="ruleForm.dipiOrderYesnoValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.dipiContent != null && ruleForm.dipiContent != 'null' && ruleForm.dipiContent != '') {
            var dipiContentUeditor = UE.getEditor('dipiContentEditor');
                dipiContentUeditor.ready(function () {
                    ...
                    dipiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
