...
<!--/Pre Loader -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="dingdanWupinSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="发货物品" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        收货人
                                        <div class="layui-input-inline">
                                            <input type="text" id="xingmingSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        单号
                                        <div class="layui-input-inline">
                                            <input type="text" id="dingdanDanhaoNumberSearch" style="width: 140px;" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //发货物品
            var dingdanWupinSearchInput = $('#dingdanWupinSearch');
            if( dingdanWupinSearchInput != null){
                if (dingdanWupinSearchInput.val() != null && dingdanWupinSearchInput.val() != '') {
                    searchForm.dingdanWupin = $('#dingdanWupinSearch').val();
                }
            }
         
            //收货人
            var xingmingSearchInput = $('#xingmingSearch');
            if( xingmingSearchInput != null){
                if (xingmingSearchInput.val() != null && xingmingSearchInput.val() != '') {
                    searchForm.xingming = $('#xingmingSearch').val();
                }
            }
             
            //单号
            var dingdanDanhaoNumberSearchInput = $('#dingdanDanhaoNumberSearch');
            if( dingdanDanhaoNumberSearchInput != null){
                if (dingdanDanhaoNumberSearchInput.val() != null && dingdanDanhaoNumberSearchInput.val() != '') {
                    searchForm.dingdanDanhaoNumber = $('#dingdanDanhaoNumberSearch').val();
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("dingdan/page", "GET", {
                ...
                order: sortOrder,
                //本表的
                dingdanWupin: searchForm.dingdanWupin,
                xingming: searchForm.xingming,
                dingdanDanhaoNumber: searchForm.dingdanDanhaoNumber,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //发货物品
            var dingdanWupinCell = document.createElement('td');
            dingdanWupinCell.innerHTML = item.dingdanWupin;
            row.appendChild(dingdanWupinCell);
            ...
            //收货人手机号
            var shouhuorenPhoneCell = document.createElement('td');
            shouhuorenPhoneCell.innerHTML = item.shouhuorenPhone;
            row.appendChild(shouhuorenPhoneCell);
            ...
            //单号
            var dingdanDanhaoNumberCell = document.createElement('td');
            dingdanDanhaoNumberCell.innerHTML = item.dingdanDanhaoNumber;
            row.appendChild(dingdanDanhaoNumberCell);
