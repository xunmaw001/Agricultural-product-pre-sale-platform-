                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>出生年月</label>
                                        <input id="kehuTime-input" name="kehuTime" type="text" class="form-control layui-input">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>客户照片</label>
...
<script>
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#kehuTime-input").val(ruleForm.kehuTime);
