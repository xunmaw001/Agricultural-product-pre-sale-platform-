            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑地皮收藏</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("dipiCollection/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
    ...
    // 获取当前详情
    function getDetails() {
        var adddipiCollection = window.sessionStorage.getItem("adddipiCollection");
        if (adddipiCollection != null && adddipiCollection != "" && adddipiCollection != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("dipiCollection/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
